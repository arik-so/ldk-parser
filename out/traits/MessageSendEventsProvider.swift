			...
			extension Bindings {
				...
				open class MessageSendEventsProvider: NativeTraitWrapper {
					...
					internal func free() {
						...
						// native method call
						let nativeCallResult = MessageSendEventsProvider_free(self.cType!)
				...
				public class NativelyImplementedMessageSendEventsProvider: MessageSendEventsProvider {
					...
					/// Gets the list of pending events which were generated by previous actions, clearing the list
					/// in the process.
					public func getAndClearPendingMsgEvents() -> [MessageSendEvent] {
						// native call variable prep
						...
						// return value (do some wrapping)
						let returnValue = Vec_MessageSendEventZ(pointer: nativeCallResult).getValue()
