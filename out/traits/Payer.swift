				...
				open class Payer: NativeTraitWrapper {
					...
					public init() {
						...
						func sendPaymentLambda(this_arg: UnsafeRawPointer?, route: UnsafePointer<LDKRoute>, payment_hash: LDKThirtyTwoBytes, payment_secret: LDKThirtyTwoBytes) -> LDKCResult_PaymentIdPaymentSendFailureZ {
							...
							// Swift callback call
							let swiftCallbackResult = instance.sendPayment(route: Route(cType: route.pointee).dangle().clone(), paymentHash: ThirtyTwoBytes(cType: payment_hash).dangle().getValue(), paymentSecret: ThirtyTwoBytes(cType: payment_secret).dangle().getValue())
						...
						func sendSpontaneousPaymentLambda(this_arg: UnsafeRawPointer?, route: UnsafePointer<LDKRoute>, payment_preimage: LDKThirtyTwoBytes) -> LDKCResult_PaymentIdPaymentSendFailureZ {
							...
							// Swift callback call
							let swiftCallbackResult = instance.sendSpontaneousPayment(route: Route(cType: route.pointee).dangle().clone(), paymentPreimage: ThirtyTwoBytes(cType: payment_preimage).dangle().getValue())
						...
						func retryPaymentLambda(this_arg: UnsafeRawPointer?, route: UnsafePointer<LDKRoute>, payment_id: LDKThirtyTwoBytes) -> LDKCResult_NonePaymentSendFailureZ {
							...
							// Swift callback call
							let swiftCallbackResult = instance.retryPayment(route: Route(cType: route.pointee).dangle().clone(), paymentId: ThirtyTwoBytes(cType: payment_id).dangle().getValue())
						...
						func abandonPaymentLambda(this_arg: UnsafeRawPointer?, payment_id: LDKThirtyTwoBytes) -> Void {
							...
							// Swift callback call
							let swiftCallbackResult = instance.abandonPayment(paymentId: ThirtyTwoBytes(cType: payment_id).dangle().getValue())
