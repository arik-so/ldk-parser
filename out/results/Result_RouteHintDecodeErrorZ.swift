			...
			extension Bindings {
				...
				public class Result_RouteHintDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: RouteHint) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_RouteHintDecodeErrorZ_ok(o.cType!)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_RouteHintDecodeErrorZ_err(e.cType!)
			...
			CResult_RouteHintDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> RouteHint? {
						if self.cType?.result_ok == true {
							return RouteHint(pointer: self.cType!.contents.result.pointee)
						}
						return nil
					}
