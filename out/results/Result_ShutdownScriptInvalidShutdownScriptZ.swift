			...
			extension Bindings {
				...
				public class Result_ShutdownScriptInvalidShutdownScriptZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_ShutdownScriptInvalidShutdownScriptZ) {
					...
					public init(cType: LDKCResult_ShutdownScriptInvalidShutdownScriptZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: ShutdownScript) -> Result_ShutdownScriptInvalidShutdownScriptZ {
						...
						// native method call
						let nativeCallResult = CResult_ShutdownScriptInvalidShutdownScriptZ_ok(o.danglingClone().cType!)
					...
					public class func initWithErr(e: InvalidShutdownScript) -> Result_ShutdownScriptInvalidShutdownScriptZ {
						...
						// native method call
						let nativeCallResult = CResult_ShutdownScriptInvalidShutdownScriptZ_err(e.danglingClone().cType!)
