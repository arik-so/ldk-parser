			...
			extension Bindings {
				...
				public class Result_NetAddressDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: NetAddress) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_NetAddressDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_NetAddressDecodeErrorZ_err(e.cType!)
				...
				CResult_NetAddressDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> NetAddress? {
						if self.cType?.result_ok == true {
							return NetAddress(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
