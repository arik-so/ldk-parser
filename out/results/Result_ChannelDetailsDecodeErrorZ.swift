			...
			extension Bindings {
				...
				public class Result_ChannelDetailsDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_ChannelDetailsDecodeErrorZ) {
					...
					public init(cType: LDKCResult_ChannelDetailsDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: ChannelDetails) -> Result_ChannelDetailsDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ChannelDetailsDecodeErrorZ_ok(o.danglingClone().cType!)
				...
				CResult_ChannelDetailsDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelDetails? {
						if self.cType?.result_ok == true {
							return ChannelDetails(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
