			...
			extension Bindings {
				...
				public class Result_ClosingSignedDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_ClosingSignedDecodeErrorZ) {
					...
					public init(cType: LDKCResult_ClosingSignedDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: ClosingSigned) -> Result_ClosingSignedDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ClosingSignedDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_ClosingSignedDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ClosingSignedDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_ClosingSignedDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ClosingSigned? {
						if self.cType?.result_ok == true {
							return ClosingSigned(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
