			...
			extension Bindings {
				...
				public class Result_ChannelFeaturesDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: ChannelFeatures) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_ChannelFeaturesDecodeErrorZ_ok(o.cType!)

						// cleanup
						

						// return value (do some wrapping)
						let returnValue = Result_ChannelFeaturesDecodeErrorZ(pointer: nativeCallResult)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_ChannelFeaturesDecodeErrorZ_err(e.cType!)
			...
			CResult_ChannelFeaturesDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelFeatures? {
						if self.cType?.result_ok == true {
							return ChannelFeatures(pointer: self.cType!.contents.result.pointee)
						}
						return nil
					}
