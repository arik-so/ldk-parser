			...
			extension Bindings {
				...
				public class Result_UpdateFailHTLCDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_UpdateFailHTLCDecodeErrorZ) {
					...
					public init(cType: LDKCResult_UpdateFailHTLCDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: UpdateFailHTLC) -> Result_UpdateFailHTLCDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_UpdateFailHTLCDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_UpdateFailHTLCDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_UpdateFailHTLCDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_UpdateFailHTLCDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> UpdateFailHTLC? {
						if self.cType?.result_ok == true {
							return UpdateFailHTLC(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
