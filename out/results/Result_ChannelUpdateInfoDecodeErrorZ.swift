			...
			extension Bindings {
				...
				public class Result_ChannelUpdateInfoDecodeErrorZ: NativeTypeWrapper {
					...
					public class func initWithOk(o: ChannelUpdateInfo) -> Result_ChannelUpdateInfoDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ChannelUpdateInfoDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_ChannelUpdateInfoDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ChannelUpdateInfoDecodeErrorZ_err(e.clone().cType!)
