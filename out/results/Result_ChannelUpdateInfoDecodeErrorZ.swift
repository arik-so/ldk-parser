			...
			extension Bindings {
				...
				public class Result_ChannelUpdateInfoDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_ChannelUpdateInfoDecodeErrorZ) {
					...
					public init(cType: LDKCResult_ChannelUpdateInfoDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: ChannelUpdateInfo) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_ChannelUpdateInfoDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_ChannelUpdateInfoDecodeErrorZ_err(e.cType!)
