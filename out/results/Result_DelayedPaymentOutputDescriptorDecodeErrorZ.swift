			...
			extension Bindings {
				...
				public class Result_DelayedPaymentOutputDescriptorDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_DelayedPaymentOutputDescriptorDecodeErrorZ) {
					...
					public init(cType: LDKCResult_DelayedPaymentOutputDescriptorDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: DelayedPaymentOutputDescriptor) -> Result_DelayedPaymentOutputDescriptorDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_DelayedPaymentOutputDescriptorDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_DelayedPaymentOutputDescriptorDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_DelayedPaymentOutputDescriptorDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_DelayedPaymentOutputDescriptorDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> DelayedPaymentOutputDescriptor? {
						if self.cType?.result_ok == true {
							return DelayedPaymentOutputDescriptor(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
