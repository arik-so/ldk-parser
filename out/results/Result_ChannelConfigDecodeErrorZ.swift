			...
			extension Bindings {
				...
				public class Result_ChannelConfigDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: ChannelConfig) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_ChannelConfigDecodeErrorZ_ok(o.cType!)

						// cleanup
						

						// return value (do some wrapping)
						let returnValue = Result_ChannelConfigDecodeErrorZ(pointer: nativeCallResult)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_ChannelConfigDecodeErrorZ_err(e.cType!)
			...
			CResult_ChannelConfigDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelConfig? {
						if self.cType?.result_ok == true {
							return ChannelConfig(pointer: self.cType!.contents.result.pointee)
						}
						return nil
					}
