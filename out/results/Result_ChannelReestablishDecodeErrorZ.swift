			...
			extension Bindings {
				...
				public class Result_ChannelReestablishDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: ChannelReestablish) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_ChannelReestablishDecodeErrorZ_ok(o.cType!)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_ChannelReestablishDecodeErrorZ_err(e.cType!)
			...
			CResult_ChannelReestablishDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelReestablish? {
						if self.cType?.result_ok == true {
							return ChannelReestablish(pointer: self.cType!.contents.result.pointee)
						}
						return nil
					}
