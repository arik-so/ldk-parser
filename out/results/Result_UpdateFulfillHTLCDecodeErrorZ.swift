			...
			extension Bindings {
				...
				public class Result_UpdateFulfillHTLCDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_UpdateFulfillHTLCDecodeErrorZ) {
					...
					public init(cType: LDKCResult_UpdateFulfillHTLCDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: UpdateFulfillHTLC) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_UpdateFulfillHTLCDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_UpdateFulfillHTLCDecodeErrorZ_err(e.cType!)
				...
				CResult_UpdateFulfillHTLCDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> UpdateFulfillHTLC? {
						if self.cType?.result_ok == true {
							return UpdateFulfillHTLC(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
