			...
			extension Bindings {
				...
				public class Result_PrivateRouteCreationErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_PrivateRouteCreationErrorZ) {
					...
					public init(cType: LDKCResult_PrivateRouteCreationErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: PrivateRoute) -> Result_PrivateRouteCreationErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_PrivateRouteCreationErrorZ_ok(o.danglingClone().cType!)
