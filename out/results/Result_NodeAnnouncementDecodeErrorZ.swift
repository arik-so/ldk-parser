			...
			extension Bindings {
				...
				public class Result_NodeAnnouncementDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_NodeAnnouncementDecodeErrorZ) {
					...
					public init(cType: LDKCResult_NodeAnnouncementDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: NodeAnnouncement) -> Result_NodeAnnouncementDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_NodeAnnouncementDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_NodeAnnouncementDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_NodeAnnouncementDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_NodeAnnouncementDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> NodeAnnouncement? {
						if self.cType?.result_ok == true {
							return NodeAnnouncement(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
