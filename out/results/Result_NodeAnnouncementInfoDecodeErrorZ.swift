			...
			extension Bindings {
				...
				public class Result_NodeAnnouncementInfoDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: NodeAnnouncementInfo) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_NodeAnnouncementInfoDecodeErrorZ_ok(o.cType!)

						// cleanup
						

						// return value (do some wrapping)
						let returnValue = Result_NodeAnnouncementInfoDecodeErrorZ(pointer: nativeCallResult)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_NodeAnnouncementInfoDecodeErrorZ_err(e.cType!)
			...
			CResult_NodeAnnouncementInfoDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> NodeAnnouncementInfo? {
						if self.cType?.result_ok == true {
							return NodeAnnouncementInfo(pointer: self.cType!.contents.result.pointee)
						}
						return nil
					}
