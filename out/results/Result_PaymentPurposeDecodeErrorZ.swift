			...
			extension Bindings {
				...
				public class Result_PaymentPurposeDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_PaymentPurposeDecodeErrorZ) {
					...
					public init(cType: LDKCResult_PaymentPurposeDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: PaymentPurpose) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_PaymentPurposeDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_PaymentPurposeDecodeErrorZ_err(e.cType!)
				...
				CResult_PaymentPurposeDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> PaymentPurpose? {
						if self.cType?.result_ok == true {
							return PaymentPurpose(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
