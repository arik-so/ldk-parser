			...
			extension Bindings {
				...
				public class Result_TxCreationKeysErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_TxCreationKeysErrorZ) {
					...
					public init(cType: LDKCResult_TxCreationKeysErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: TxCreationKeys) -> Result_TxCreationKeysErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_TxCreationKeysErrorZ_ok(o.danglingClone().cType!)
