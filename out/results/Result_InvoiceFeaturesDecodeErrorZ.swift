			...
			extension Bindings {
				...
				public class Result_InvoiceFeaturesDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_InvoiceFeaturesDecodeErrorZ) {
					...
					public init(cType: LDKCResult_InvoiceFeaturesDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: InvoiceFeatures) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_InvoiceFeaturesDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_InvoiceFeaturesDecodeErrorZ_err(e.cType!)
				...
				CResult_InvoiceFeaturesDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> InvoiceFeatures? {
						if self.cType?.result_ok == true {
							return InvoiceFeatures(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
