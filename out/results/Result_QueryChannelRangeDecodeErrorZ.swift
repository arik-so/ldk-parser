			...
			extension Bindings {
				...
				public class Result_QueryChannelRangeDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_QueryChannelRangeDecodeErrorZ) {
					...
					public init(cType: LDKCResult_QueryChannelRangeDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: QueryChannelRange) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_QueryChannelRangeDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_QueryChannelRangeDecodeErrorZ_err(e.cType!)
				...
				CResult_QueryChannelRangeDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> QueryChannelRange? {
						if self.cType?.result_ok == true {
							return QueryChannelRange(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
