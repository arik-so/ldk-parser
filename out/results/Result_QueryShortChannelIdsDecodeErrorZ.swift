			...
			extension Bindings {
				...
				public class Result_QueryShortChannelIdsDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: QueryShortChannelIds) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_QueryShortChannelIdsDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_QueryShortChannelIdsDecodeErrorZ_err(e.cType!)
				...
				CResult_QueryShortChannelIdsDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> QueryShortChannelIds? {
						if self.cType?.result_ok == true {
							return QueryShortChannelIds(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
