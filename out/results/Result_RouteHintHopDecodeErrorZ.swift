			...
			extension Bindings {
				...
				public class Result_RouteHintHopDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_RouteHintHopDecodeErrorZ) {
					...
					public init(cType: LDKCResult_RouteHintHopDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: RouteHintHop) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_RouteHintHopDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_RouteHintHopDecodeErrorZ_err(e.cType!)
				...
				CResult_RouteHintHopDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> RouteHintHop? {
						if self.cType?.result_ok == true {
							return RouteHintHop(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
