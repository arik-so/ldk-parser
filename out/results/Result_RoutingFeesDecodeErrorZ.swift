			...
			extension Bindings {
				...
				public class Result_RoutingFeesDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_RoutingFeesDecodeErrorZ) {
					...
					public init(cType: LDKCResult_RoutingFeesDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: RoutingFees) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_RoutingFeesDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_RoutingFeesDecodeErrorZ_err(e.cType!)
				...
				CResult_RoutingFeesDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> RoutingFees? {
						if self.cType?.result_ok == true {
							return RoutingFees(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
