			...
			extension Bindings {
				...
				public class Result_ChannelTypeFeaturesDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_ChannelTypeFeaturesDecodeErrorZ) {
					...
					public init(cType: LDKCResult_ChannelTypeFeaturesDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: ChannelTypeFeatures) -> Result_ChannelTypeFeaturesDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ChannelTypeFeaturesDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_ChannelTypeFeaturesDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ChannelTypeFeaturesDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_ChannelTypeFeaturesDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ChannelTypeFeatures? {
						if self.cType?.result_ok == true {
							return ChannelTypeFeatures(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
