			...
			extension Bindings {
				...
				public class Result_InMemorySignerDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_InMemorySignerDecodeErrorZ) {
					...
					public init(cType: LDKCResult_InMemorySignerDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: InMemorySigner) -> Result_InMemorySignerDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_InMemorySignerDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_InMemorySignerDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_InMemorySignerDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_InMemorySignerDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> InMemorySigner? {
						if self.cType?.result_ok == true {
							return InMemorySigner(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
