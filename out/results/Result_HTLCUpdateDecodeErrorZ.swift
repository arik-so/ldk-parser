			...
			extension Bindings {
				...
				public class Result_HTLCUpdateDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: HTLCUpdate) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_HTLCUpdateDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_HTLCUpdateDecodeErrorZ_err(e.cType!)
				...
				CResult_HTLCUpdateDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> HTLCUpdate? {
						if self.cType?.result_ok == true {
							return HTLCUpdate(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
