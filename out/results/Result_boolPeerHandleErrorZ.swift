			...
			extension Bindings {
				...
				public class Result_boolPeerHandleErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_boolPeerHandleErrorZ) {
					...
					public init(cType: LDKCResult_boolPeerHandleErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithErr(e: PeerHandleError) -> Result_boolPeerHandleErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_boolPeerHandleErrorZ_err(e.danglingClone().cType!)
