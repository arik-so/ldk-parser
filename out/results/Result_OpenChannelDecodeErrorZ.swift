			...
			extension Bindings {
				...
				public class Result_OpenChannelDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_OpenChannelDecodeErrorZ) {
					...
					public init(cType: LDKCResult_OpenChannelDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: OpenChannel) -> Result_OpenChannelDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_OpenChannelDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_OpenChannelDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_OpenChannelDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_OpenChannelDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> OpenChannel? {
						if self.cType?.result_ok == true {
							return OpenChannel(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
