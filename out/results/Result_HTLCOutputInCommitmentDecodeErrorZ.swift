			...
			extension Bindings {
				...
				public class Result_HTLCOutputInCommitmentDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_HTLCOutputInCommitmentDecodeErrorZ) {
					...
					public init(cType: LDKCResult_HTLCOutputInCommitmentDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: HTLCOutputInCommitment) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_HTLCOutputInCommitmentDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_HTLCOutputInCommitmentDecodeErrorZ_err(e.cType!)
				...
				CResult_HTLCOutputInCommitmentDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> HTLCOutputInCommitment? {
						if self.cType?.result_ok == true {
							return HTLCOutputInCommitment(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
