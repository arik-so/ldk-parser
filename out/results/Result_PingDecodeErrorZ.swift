			...
			extension Bindings {
				...
				public class Result_PingDecodeErrorZ: NativeTypeWrapper {
					...
					public init(o: Ping) {
						...
						// native method call
						let nativeCallResult = CResult_PingDecodeErrorZ_ok(o.cType!)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_PingDecodeErrorZ_err(e.cType!)
			...
			CResult_PingDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> Ping? {
						if self.cType?.result_ok == true {
							return Ping(pointer: self.cType!.contents.result.pointee)
						}
						return nil
					}
