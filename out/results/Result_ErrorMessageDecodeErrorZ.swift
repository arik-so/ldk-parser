			...
			extension Bindings {
				...
				public class Result_ErrorMessageDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_ErrorMessageDecodeErrorZ) {
					...
					public init(cType: LDKCResult_ErrorMessageDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: ErrorMessage) -> Result_ErrorMessageDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ErrorMessageDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_ErrorMessageDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_ErrorMessageDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_ErrorMessageDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> ErrorMessage? {
						if self.cType?.result_ok == true {
							return ErrorMessage(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
