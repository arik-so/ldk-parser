			...
			extension Bindings {
				...
				public class Result_NodeAliasDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_NodeAliasDecodeErrorZ) {
					...
					public init(cType: LDKCResult_NodeAliasDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: NodeAlias) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_NodeAliasDecodeErrorZ_ok(o.cType!)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_NodeAliasDecodeErrorZ_err(e.cType!)
				...
				CResult_NodeAliasDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> NodeAlias? {
						if self.cType?.result_ok == true {
							return NodeAlias(cType: self.cType!.contents.result.pointee)
						}
						return nil
					}
