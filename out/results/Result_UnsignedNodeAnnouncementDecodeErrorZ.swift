			...
			extension Bindings {
				...
				public class Result_UnsignedNodeAnnouncementDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_UnsignedNodeAnnouncementDecodeErrorZ) {
					...
					public init(cType: LDKCResult_UnsignedNodeAnnouncementDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(o: UnsignedNodeAnnouncement) {
						// native call variable prep
						

						// native method call
						let nativeCallResult = CResult_UnsignedNodeAnnouncementDecodeErrorZ_ok(o.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(e: DecodeError) {
						...
						// native method call
						let nativeCallResult = CResult_UnsignedNodeAnnouncementDecodeErrorZ_err(e.cType!)
				...
				CResult_UnsignedNodeAnnouncementDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> UnsignedNodeAnnouncement? {
						if self.cType?.result_ok == true {
							return UnsignedNodeAnnouncement(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
