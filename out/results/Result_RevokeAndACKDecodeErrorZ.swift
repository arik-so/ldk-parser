			...
			extension Bindings {
				...
				public class Result_RevokeAndACKDecodeErrorZ: NativeTypeWrapper {
					...
					public init(cType: LDKCResult_RevokeAndACKDecodeErrorZ) {
					...
					public init(cType: LDKCResult_RevokeAndACKDecodeErrorZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public class func initWithOk(o: RevokeAndACK) -> Result_RevokeAndACKDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_RevokeAndACKDecodeErrorZ_ok(o.clone().cType!)
					...
					public class func initWithErr(e: DecodeError) -> Result_RevokeAndACKDecodeErrorZ {
						...
						// native method call
						let nativeCallResult = CResult_RevokeAndACKDecodeErrorZ_err(e.clone().cType!)
				...
				CResult_RevokeAndACKDecodeErrorZ_clone(origPointer)
					...
					public func getValue() -> RevokeAndACK? {
						if self.cType?.result_ok == true {
							return RevokeAndACK(cType: self.cType!.contents.result.pointee, anchor: self).dangle()
						}
						return nil
					}
