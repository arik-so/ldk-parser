			...
			extension Bindings {
				...
				internal class Vec_C2Tuple_BlockHashChannelMonitorZZ: NativeTypeWrapper {
					...
					public init(cType: LDKCVec_C2Tuple_BlockHashChannelMonitorZZ) {
					...
					public init(cType: LDKCVec_C2Tuple_BlockHashChannelMonitorZZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(array: [([UInt8], ChannelMonitor)]) {
						...
						let currentValueDepth1Tuple = Tuple_BlockHashChannelMonitorZ(tuple: currentValueDepth1)
