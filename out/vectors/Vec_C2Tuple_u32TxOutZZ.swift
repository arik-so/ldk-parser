			...
			extension Bindings {
				...
				internal class Vec_C2Tuple_u32TxOutZZ: NativeTypeWrapper {
					...
					public init(cType: LDKCVec_C2Tuple_u32TxOutZZ) {
					...
					public init(cType: LDKCVec_C2Tuple_u32TxOutZZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public init(array: [(UInt32, TxOut)]) {
						...
						let currentValueDepth1Tuple = Tuple_u32TxOutZ(tuple: currentValueDepth1)
