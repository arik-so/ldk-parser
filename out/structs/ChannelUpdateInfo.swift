			...
			extension Bindings {
				...
				public class ChannelUpdateInfo: NativeTypeWrapper {
					...
					public func getLastUpdate() -> UInt32 {
						...
						withUnsafePointer(to: self.danglingClone().cType!) { (thisPtrPointer: UnsafePointer<LDKChannelUpdateInfo>) in
				ChannelUpdateInfo_get_last_update(thisPtrPointer)
					...
					public func setLastUpdate(val: UInt32) {
						...
						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.danglingClone().cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKChannelUpdateInfo>) in
				...
				ChannelUpdateInfo_clone(origPointer)
					...
					public class func eq(a: ChannelUpdateInfo, b: ChannelUpdateInfo) -> Bool {
						...
						// native method call
						let nativeCallResult = 
						withUnsafePointer(to: a.danglingClone().cType!) { (aPointer: UnsafePointer<LDKChannelUpdateInfo>) in
				
						withUnsafePointer(to: b.danglingClone().cType!) { (bPointer: UnsafePointer<LDKChannelUpdateInfo>) in
				ChannelUpdateInfo_eq(aPointer, bPointer)
					...
					public func write() -> [UInt8] {
						...
						// native method call
						let nativeCallResult = 
						withUnsafePointer(to: self.danglingClone().cType!) { (objPointer: UnsafePointer<LDKChannelUpdateInfo>) in
