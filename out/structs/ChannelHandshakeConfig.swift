			...
			extension Bindings {
				...
				public class ChannelHandshakeConfig: NativeTypeWrapper {
					...
					public init(cType: LDKChannelHandshakeConfig) {
					...
					public init(cType: LDKChannelHandshakeConfig, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
					...
					public func getMinimumDepth() -> UInt32 {
						...
						withUnsafePointer(to: self.danglingClone().cType!) { (thisPtrPointer: UnsafePointer<LDKChannelHandshakeConfig>) in
				ChannelHandshakeConfig_get_minimum_depth(thisPtrPointer)
					...
					public func setMinimumDepth(val: UInt32) {
						...
						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.danglingClone().cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKChannelHandshakeConfig>) in
