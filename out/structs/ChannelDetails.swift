			...
			extension Bindings {
				...
				public class ChannelDetails: NativeTypeWrapper {
					...
					public func getChannelId() -> [UInt8]? {
						...
						withUnsafePointer(to: self.danglingClone().cType!) { (thisPtrPointer: UnsafePointer<LDKChannelDetails>) in
				ChannelDetails_get_channel_id(thisPtrPointer)
					...
					public func setChannelId(val: [UInt8]) {
						...
						// native method call
						let nativeCallResult = 
						withUnsafeMutablePointer(to: &self.danglingClone().cType!) { (thisPtrPointer: UnsafeMutablePointer<LDKChannelDetails>) in
				...
				ChannelDetails_clone(origPointer)
					...
					public func getInboundPaymentScid() -> UInt64? {
						...
						// native method call
						let nativeCallResult = 
						withUnsafePointer(to: self.danglingClone().cType!) { (thisArgPointer: UnsafePointer<LDKChannelDetails>) in
				...
				ChannelDetails_get_outbound_payment_scid(thisArgPointer)
					...
					public func write() -> [UInt8] {
						...
						// native method call
						let nativeCallResult = 
						withUnsafePointer(to: self.danglingClone().cType!) { (objPointer: UnsafePointer<LDKChannelDetails>) in
