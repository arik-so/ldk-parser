			...
			extension Bindings {
				...
				public class NodeFeatures: NativeTypeWrapper {
					...
					public init(cType: LDKNodeFeatures) {
					...
					public init(cType: LDKNodeFeatures, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
					...
					public func eq() -> Bool {
						...
						withUnsafePointer(to: self.cType!) { (aPointer: UnsafePointer<LDKNodeFeatures>) in
				
						withUnsafePointer(to: self.cType!) { (bPointer: UnsafePointer<LDKNodeFeatures>) in
