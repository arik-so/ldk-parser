			...
			extension Bindings {
				...
				MessageSendEvent_clone(origPointer)
					...
					public class func initWithSendAcceptChannel(nodeId: [UInt8], msg: Bindings.AcceptChannel) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_accept_channel(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendOpenChannel(nodeId: [UInt8], msg: Bindings.OpenChannel) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_open_channel(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendFundingCreated(nodeId: [UInt8], msg: Bindings.FundingCreated) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_funding_created(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendFundingSigned(nodeId: [UInt8], msg: Bindings.FundingSigned) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_funding_signed(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendChannelReady(nodeId: [UInt8], msg: Bindings.ChannelReady) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_channel_ready(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendAnnouncementSignatures(nodeId: [UInt8], msg: Bindings.AnnouncementSignatures) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_announcement_signatures(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithUpdateHtlcs(nodeId: [UInt8], updates: Bindings.CommitmentUpdate) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_update_htlcs(nodeIdPrimitiveWrapper.cType!, updates.danglingClone().cType!)
					...
					public class func initWithSendRevokeAndAck(nodeId: [UInt8], msg: Bindings.RevokeAndACK) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_revoke_and_ack(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendClosingSigned(nodeId: [UInt8], msg: Bindings.ClosingSigned) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_closing_signed(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendShutdown(nodeId: [UInt8], msg: Bindings.Shutdown) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_shutdown(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendChannelReestablish(nodeId: [UInt8], msg: Bindings.ChannelReestablish) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_channel_reestablish(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendChannelAnnouncement(nodeId: [UInt8], msg: Bindings.ChannelAnnouncement, updateMsg: Bindings.ChannelUpdate) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_channel_announcement(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!, updateMsg.danglingClone().cType!)
					...
					public class func initWithBroadcastChannelAnnouncement(msg: Bindings.ChannelAnnouncement, updateMsg: Bindings.ChannelUpdate) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_broadcast_channel_announcement(msg.danglingClone().cType!, updateMsg.danglingClone().cType!)
					...
					public class func initWithBroadcastChannelUpdate(msg: Bindings.ChannelUpdate) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_broadcast_channel_update(msg.danglingClone().cType!)
					...
					public class func initWithSendChannelUpdate(nodeId: [UInt8], msg: Bindings.ChannelUpdate) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_channel_update(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendChannelRangeQuery(nodeId: [UInt8], msg: Bindings.QueryChannelRange) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_channel_range_query(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendShortIdsQuery(nodeId: [UInt8], msg: Bindings.QueryShortChannelIds) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_short_ids_query(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendReplyChannelRange(nodeId: [UInt8], msg: Bindings.ReplyChannelRange) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_reply_channel_range(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
					...
					public class func initWithSendGossipTimestampFilter(nodeId: [UInt8], msg: Bindings.GossipTimestampFilter) -> MessageSendEvent {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_send_gossip_timestamp_filter(nodeIdPrimitiveWrapper.cType!, msg.danglingClone().cType!)
