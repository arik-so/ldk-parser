			...
			extension Bindings {
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(msg: Bindings.ChannelAnnouncement, updateMsg: Bindings.ChannelUpdate) {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_broadcast_channel_announcement(msg.cType!, updateMsg.cType!)
				...
				super.init(conflictAvoidingVariableName: 0)
					...
					public init(msg: Bindings.ChannelUpdate) {
						...
						// native method call
						let nativeCallResult = MessageSendEvent_broadcast_channel_update(msg.cType!)
