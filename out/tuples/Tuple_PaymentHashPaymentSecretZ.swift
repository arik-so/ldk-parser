			...
			extension Bindings {
				...
				internal class Tuple_PaymentHashPaymentSecretZ: NativeTypeWrapper {
					...
					public init(cType: LDKC2Tuple_PaymentHashPaymentSecretZ) {
					...
					public init(cType: LDKC2Tuple_PaymentHashPaymentSecretZ, anchor: NativeTypeWrapper) {
						Self.instanceCounter += 1
						self.instanceNumber = Self.instanceCounter
						self.cType = cType
						super.init(conflictAvoidingVariableName: 0)
			...
			C2Tuple_PaymentHashPaymentSecretZ_clone(origPointer)
						...
						let returnValue = Tuple_PaymentHashPaymentSecretZ(cType: nativeCallResult).getValue()
					...
					public init(a: [UInt8], b: [UInt8]) {
						...
						// native method call
						let nativeCallResult = C2Tuple_PaymentHashPaymentSecretZ_new(a.cType!, b.cType!)
					...
					internal func dangle() -> Tuple_PaymentHashPaymentSecretZ {
						self.dangling = true
						return self
					}
